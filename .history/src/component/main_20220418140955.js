...
// axios.get(
//   `http://api.openweathermap.org/data/2.5/forecast?id=524901&appid=${weather_KEY}`
// );
...
function MainPage() {
  ...
  function findUserLocation() {
    ...
    navigator.geolocation(sucess, error);
  }

  const [findUser, setFindUser] = useState("loading");
