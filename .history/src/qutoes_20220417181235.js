...
const randomQuoteENG = quote[randomIndex].quoteENG;
const randomQuoteKR = quote[randomIndex].quoteKR;
const randomQuoteAuthor = quote[randomIndex].quoteAuthor;

console.log(randomQuote);
console.log(randomQuoteAuthor);
console.log(randomQuoteENG);
